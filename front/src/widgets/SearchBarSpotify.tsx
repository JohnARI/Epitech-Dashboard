...
export function SearchBarSpotify({playNow, addToWaitingList, autoPlay}) {
    ...
    // TODO: if user-widget contains spotify, then render this component
    ...
    const [widgetInfo, setWidgetInfo] = useState(localStorage.getItem("user-widget") || undefined)
        ...
        <div className="spotifySearch">
            ...
            <div>
                {searchResult.map(track => (
                    <TrackSearchResult track={track} key={track.uri} autoPlay={autoPlay} playNow={playNow}
